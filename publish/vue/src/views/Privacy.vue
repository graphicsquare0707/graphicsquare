...
<ul>
  ...
  <li>お客様の承諾・申込みに基づく、提携事業者・団体等への個人情報の提供のため</li>
...
<p>Cookie（クッキー）を無効にする方法や「Google アドセンス」に関する詳細は <a href="https://policies.google.com/technologies/ads?gl=jp" target="_blank">こちら</a> をご覧ください。</p>
...
<p>同サービスのプライバシーポリシーは <a href="https://automattic.com/privacy/" target="_blank">こちら</a> をご覧ください。</p>
...
<p>本プライバシーポリシーは、事前の予告なく変更することがあります。本プライバシーポリシーの変更は、当サイトに掲載された時点で有効になるものとします。</p>
